const turkiyeIllerIlceler = {
  ...
  Çankırı: ["Atkaracalar", "Bayramören", "Çerkeş", "Eldivan", "Ilgaz", "Kızılırmak", "Korgun", "Merkez", "Orta", "Şabanözü", "Yapraklı"],
  ...
  Kars: ["Arpaçay", "Digor", "Kağızman", "Merkez", "Sarıkamış", "Selim", "Susuz"],
  Kastamonu: ["Abana", "Ağlı", "Araç", "Azdavay", "Bozkurt", "Cide", "Çatalzeytin", "Daday", "Devrekani", "Doğanyurt", "Hanönü", "İhsangazi", "İnebolu", "Küre", "Merkez", "Pınarbaşı", "Seydiler", "Şenpazar", "Taşköprü", "Tosya"],
  Kayseri: ["Akkışla", "Bünyan", "Develi", "Felahiye", "Hacılar", "İncesu", "Kocasinan", "Melikgazi", "Özvatan", "Pınarbaşı", "Sarıoğlan", "Sarız", "Talas", "Tomarza", "Yahyalı", "Yeşilhisar"],
  Kırıkkale: ["Bahşılı", "Balışeyh", "Çelebi", "Delice", "Karakeçili", "Keskin", "Merkez", "Sulakyurt", "Yahşihan"],
  Kırklareli: ["Babaeski", "Demirköy", "Kofçaz", "Lüleburgaz", "Merkez", "Pehlivanköy", "Pınarhisar", "Vize"],
  Kırşehir: ["Akpınar", "Aksaray", "Boztepe", "Çiçekdağı", "Kaman", "Merkez", "Mucur"],
  ...
  Trabzon: ["Akçaabat", "Araklı", "Arsin", "Beşikdüzü", "Çarşıbaşı", "Çaykara", "Dernekpazarı", "Düzköy", "Hayrat", "Köprübaşı", "Maçka", "Merkez", "Of", "Sürmene", "Şalpazarı", "Tonya", "Vakfıkebir", "Yomra"],
  Tunceli: ["Çemişgezek", "Hozat", "Mazgirt", "Merkez", "Nazımiye", "Ovacık", "Pertek", "Pülümür"],
  Uşak: ["Banaz", "Eşme", "Karahallı", "Merkez", "Sivaslı", "Ulubey"],
  Van: ["Bahçesaray", "Başkale", "Çaldıran", "Çatak", "Edremit", "Erciş", "Gevaş", "Gürpınar", "İpekyolu", "Muradiye", "Özalp", "Saray", "Tuşba"],
  Yalova: ["Altınova", "Armutlu", "Çınarcık", "Merkez", "Termal"],
  Yozgat: ["Akdağmadeni", "Aydıncık", "Boğazlıyan", "Çandır", "Çayıralan", "Çekerek", "Merkez", "Saraykent", "Sarıkaya", "Sorgun", "Şefaatli", "Yenifakılı", "Yerköy"],
...
Object.keys(turkiyeIllerIlceler).forEach((il) => {
...
sehirSelect.addEventListener("change", function () {
  ...
  turkiyeIllerIlceler[selectedIl].forEach((ilce) => {
    let option = document.createElement("option");
    option.value = ilce;
    option.text = ilce;
...
window.onload = function () {
  ...
  if (selectedCity) {
    sehirSelect.value = selectedCity;

    // Seçilen şehir için ilçeleri yükleyin
    const ilceler = turkiyeIllerIlceler[selectedCity];
    ilceSelect.innerHTML = "";
    ...
    // İlk şehri ve ilçeleri yükleyin
    const firstIl = sehirSelect.options[0].value;
    turkiyeIllerIlceler[firstIl].forEach((ilce) => {
      let option = document.createElement("option");
      option.value = ilce;
      option.text = ilce;
      ilceSelect.appendChild(option);
